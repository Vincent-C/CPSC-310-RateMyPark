 ...
 * URI: https://github.com/branflake2267/GWT-Maps-V3-Api/blob/master/gwt-maps-showcase/src/main/java/com/google/gwt/maps/testing/client/maps/StreetViewSideBySideMapWidget.java
 * 
 * #%L
...
public class StreetViewSideBySideMapWidget extends Composite {
  ...
  public StreetViewSideBySideMapWidget(Double latitude, Double longitude) {
  ...
  private void drawMap() {
    LatLng berkley = LatLng.newInstance(latitude, longitude);
  ...
  private void drawStreeView() {
    LatLng position = LatLng.newInstance(latitude, longitude);
